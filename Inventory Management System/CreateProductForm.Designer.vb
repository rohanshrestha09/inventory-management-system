...
Partial Class CreateProductForm
    ...
    Private Sub InitializeComponent()
        ...
        CreateProductContainer.TabIndex = 6
        ' 
        ' Panel11
        ' 
        Panel11.Controls.Add(CancelButton)
        Panel11.Controls.Add(CreateProductButton)
        ...
        CreateProductButton.Dock = DockStyle.Left
        ...
        CreateProductButton.Location = New Point(10, 10)
        CreateProductButton.Name = "CreateProductButton"
        CreateProductButton.Size = New Size(210, 36)
        CreateProductButton.TabIndex = 7
