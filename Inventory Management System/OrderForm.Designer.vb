...
Partial Class OrderForm
    ...
    Private Sub InitializeComponent()
        ...
        SearchInputPanel.Size = New Size(752, 36)
        ...
        SearchInput.Size = New Size(746, 16)
        ...
        CreateOrderButton.Location = New Point(760, 0)
        CreateOrderButton.Name = "CreateOrderButton"
        CreateOrderButton.Size = New Size(133, 36)
        ...
        OrdersTable.Columns.AddRange(New DataGridViewColumn() {OrderID, Customer, ShopName, TotalOrderAmount, OrderedAt, DeliveryStatus, PaymentMethod})
